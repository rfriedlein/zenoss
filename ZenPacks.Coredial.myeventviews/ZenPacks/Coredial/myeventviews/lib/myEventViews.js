...
var myEventViews = YAHOO.zenoss.Subclass.create(
    YAHOO.zenoss.portlet.Portlet);

myEventViews.prototype = {
    __class__: "YAHOO.zenoss.portlet.myEventViews",
    __init__: function(args) {
        args = args || {};
        id = 'id' in args? args.id : getUID('myeventviews');
        baseLoc = 'zport/dmd/ZenPackManager/packs/ZenPacks.Coredial.myeventviews/myEventViews';
...
YAHOO.zenoss.portlet.myEventViews = myEventViews;
